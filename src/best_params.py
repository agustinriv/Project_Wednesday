...
def cargar_mejores_hiperparametros(archivo_base: str = None) -> Tuple[Dict, Optional[int]]:
    """
    ...
    try:
        ...
        best_iter = mejor_iteracion.get('best_iteration', None)
        ...
        return mejores_params, best_iter
