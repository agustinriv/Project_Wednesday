...
def main():
    ...
    df = feature_engineering_lag(df, ["mrentabilidad"], 2)
    df = feature_engineering_delta(df, ["mrentabilidad"], 2)
    ...
    X_final = train_final.drop(columns=['clase_ternaria','target'])
    y_final = train_final['clase_ternaria']
